...
export default function TechnicianEnRouteScreen({ route, navigation }) {
  ...
  // Handle Cancel - Show confirmation with 5% charge warning
        ...
        <View style={styles.headerCenter}>
          ...
          <View style={styles.etaChip}>
            ...
            <Text style={styles.etaText}>
              {order.duration_text || order.duration || "Calculating..."}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.paymentSummary}>
          ...
          <View style={styles.paymentRow}>
            <View style={styles.paymentLabelRow}>
              ...
              <Text style={styles.paymentLabel}>Due After Service</Text>
            </View>
        ...
        <View style={styles.cancelSection}>
          <View style={styles.cancelInfo}>
            ...
            <Text style={styles.cancelInfoText}>
              5% cancellation charge applies after technician assigned
            </Text>
          </View>
